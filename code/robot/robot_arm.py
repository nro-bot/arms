...
from .simulation_controller import SimulatorController
import constants
...
class RobotArm:
    ...
    def open_gripper(self):
        ...
        '''
        return self.set_gripper_state(constants.GRIPPER_OPENED)
    ...
    def close_gripper(self):
        ...
        bool
            True if desired gripper state was achieved
        '''
        return self.set_gripper_state(constants.GRIPPER_CLOSED, backoff=-0.05)
    ...
    def hand_rot_as_quat(self, pos, pitch_roll):
